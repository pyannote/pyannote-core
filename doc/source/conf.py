...
project = u'pyannote.core'
copyright = u'2017, Hervé Bredin'
...
version = pyannote.core.__version__.split('+')[0]
# The full version, including alpha/beta/rc tags.
release = pyannote.core.__version__
...
latex_documents = [
    (master_doc, 'pyannotecore.tex', u'pyannote.core Documentation',
...
man_pages = [
    (master_doc, 'pyannotecore', u'pyannote.core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyannotecore', u'pyannote.core Documentation',
     author, 'pyannotecore', 'One line description of project.',
     'Miscellaneous'),
]
